        ...
        <div className='container py-5 px-5 w-80 justify-center items-center bg-black-100 rounded-2xl border-2'>
            <Tilt className="w-full justify-center items-center">
                <motion.div
                    ...
                    className='w-64 green-pink-gradient p-[1px] rounded-[180px] shadow-card'
                >
            ...
            <div className='flex-col mt-5'>
                <ul className="list-none">
                    <li className="relative py-2">
                        <Link className='flex h-12 cursor-pointer justify-evenly items-center rounded-[5px] px-6 py-4 transition ease-in-out delay-150 bg-tertiary hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300'>
                            Newsfeed
                        </Link>
                    </li>
                    <li className="relative py-2">
